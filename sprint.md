...
- [ ] Substitution système (Core Text) + 14 polices standard — non fait ; sans police intégrée (cas des polices standard non embarquées, ex. Helvetica), aucun contour n'est disponible et le glyphe reste non dessiné (`pdf-render` ne triche pas avec une forme de repli).
