...
| `DCTDecode` (JPEG), `CCITTFax`, `JBIG2`, `JPX` | **pas implémentés** → `PdfError::UnsupportedFilter` |
...
pub enum DisplayItem {
    ...
    Glyph { font, code, unicode, transform, color, advance_is_estimated },
    Image { resource, transform },
}
```
...
## 10. Rendu ([pdf-render/src/lib.rs](../pdf-render/src/lib.rs))
...
## 11. Ce qu'il faut savoir avant de contribuer
...
pdf-core/src/
  ...
  filters.rs    Flate/LZW/ASCIIHex/ASCII85 + prédicteurs PNG/TIFF
...
pdf-render/src/
  lib.rs        rasterisation tiny-skia (chemins + glyphes) → PNG
pdf-cli/src/
