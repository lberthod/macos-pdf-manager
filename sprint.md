...
**Critère de sortie :** navigation fluide sur de gros documents (centaines de pages), recherche fonctionnelle. **Statut réel :** recherche fonctionnelle avec surlignage, miniatures, signets, cache de rendu par page et défilement continu faits ; il ne reste que le back-end GPU `wgpu` et la sélection de texte à la souris pour clore complètement ce sprint.
