...
29 fixtures PDF dans [pdf-core/tests/fixtures/](./pdf-core/tests/fixtures/) (voir leur [README](./pdf-core/tests/fixtures/README.md) pour le détail et les scripts de régénération — `acroform_checkbox.pdf`/`acroform_radio.pdf`/`acroform_choice.pdf` ajoutés aux Sprints 52-54, `encrypted_user_password.pdf` au Sprint 58), plus `sample_image.jpg` (Sprint 15-16 : une petite image JPEG synthétique, pas un PDF, utilisée pour tester `pdf-edit::insert_image_page`) :
